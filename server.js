...
// --- Define placeholder API routes to prevent ReferenceError ---
...
// 4. API routes (must be BEFORE SPA catch-all)
...
io.on('connection', socket => {
    ...
    socket.on('message', msg => {
        io.emit('message', msg); // two-way broadcast
    });
});
